...
echo
echo '===== Script para efetuar teste do susy ====='
echo 'Digite a Materia e turma(exemplo MC102wy):'
read link;
echo 'Digite o numero do lab:'
read nlab;
echo 'Ha zero antes do numero do arquivo de teste(por exemplo arq01) sim ou nao ?'
read hazero
echo 'Digite a quantidade de testes abertos para baixar:'
read qtd;
echo 'Digite o nome do programa compilado:'
read nomePrograma;
echo 'Começando a baixar os teste e saidas esperadas!'
